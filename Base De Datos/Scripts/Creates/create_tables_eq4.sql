...
DROP TABLE USUARIOS;
DROP TABLE TEMP_XML_CLASIFICACION;
DROP TABLE TEMP_XML_JORNADAS;
DROP TABLE TEMP_XML_ULTIMAJORNADA;

DROP PUBLIC SYNONYM PERSONAL;
DROP PUBLIC SYNONYM PLANTILLA;
...
CREATE TABLE PARTIDOS(
    ...
    CONSTRAINT PAR_ID_EQUV_FK FOREIGN KEY (ID_EQUIPO_LOCAL) REFERENCES EQUIPOS(ID_EQUIPO),
    CONSTRAINT PAR_ID_EQUL_FK FOREIGN KEY (ID_EQUIPO_VISITANTE) REFERENCES EQUIPOS(ID_EQUIPO),
...
CREATE TABLE TEMP_XML_JORNADAS(
    RESULTADO CLOB,
    FECHA_EXPIRACION DATE
);
...
--SINONIMOS
CREATE PUBLIC SYNONYM PERSONAL FOR EQDAW04.EQUIPOS_STAFFS;

CREATE PUBLIC SYNONYM PLANTILLA FOR EQDAW04.EQUIPOS_JUGADORES;
