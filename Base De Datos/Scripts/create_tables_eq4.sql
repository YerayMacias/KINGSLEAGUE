...
CREATE TABLE PARTIDOS_LOCALES(
	...
	ID_PARTIDO NUMBER,
	GOLES_LOCAL NUMBER,
	CONSTRAINT PAR_LOC_IDS_PK PRIMARY KEY (ID_EQUIPO_LOCAL, ID_PARTIDO),
	CONSTRAINT PAR_LOC_ID_EQU_FK FOREIGN KEY (ID_EQUIPO_LOCAL) REFERENCES EQUIPOS(ID_EQUIPO),
...
CREATE TABLE PARTIDOS_VISITANTES(
	...
	CONSTRAINT PAR_VIS_IDS_PK PRIMARY KEY (ID_EQUIPO_VISITANTE, ID_PARTIDO),
	CONSTRAINT PAR_VIS_ID_EQU_FK FOREIGN KEY (ID_EQUIPO_VISITANTE) REFERENCES EQUIPOS(ID_EQUIPO),
